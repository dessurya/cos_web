...
@section('title')
	<title>Circle - Circles Of Sustainability</title>
@endsection

@section('meta')
	<meta name="title" content="Circle - Circles Of Sustainability">
...
@section('body')
	...
	<div id="list-float" class="boxs">
		...
		<div class="item">
			<div class="flot img">
				<div id="pict" style="background-image: url('{{ asset('asset/picture/circle/'.$list->id.'/'.$list->picture) }}');">
					<div class="tab">
						<div class="row">
							<div class="col">
								<div id="absen"></div>
					...
					<div class="row">
						<div class="col">
							<div>
								...
								<a class="links" href="{{ route('main.circle.show', ['slug' => $list->slug]) }}">View More</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div id="ajax" class="boxs">
		<div class="wrapper text-center">
			...
			<a id="call-data" class="btn-dft" href="{{ route('main.circle.data') }}">Load More</a>
		</div>
	</div>
